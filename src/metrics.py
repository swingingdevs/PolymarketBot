...
FEED_LAG_SECONDS = Gauge("bot_feed_lag_seconds", "Current feed lag in seconds", ["feed"])
FEED_BLOCKED_STALE_PRICE = Gauge(
    "bot_feed_blocked_stale_price",
    "1 if stale price feed is currently blocking trading",
)
